...
<head>
  ...
  <title>Papelería Lupita - Eliminar</title>
...
<body>
  <div class="main-container">
      ...
      <div class="form-header">
          <div class="form-title">Eliminar Registro</div>
      </div>
      <form id="eliminar-form" action="procesar/eliminar_registro.php" method="POST">
